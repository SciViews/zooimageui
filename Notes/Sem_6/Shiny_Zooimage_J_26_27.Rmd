...
Par exemple, on pourrait inspecter les performances de l'algorithme random forest, avec un échantillon réalistique qui contient une moitié de particules non vivantes (neige marine ou débris), et une communauté de zooplancton dominée par les "calanoid copepods" et les "chaetognaths" de cette manière :
